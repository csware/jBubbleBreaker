...
public class Bubble3DCircleSix extends Bubble3DCircle {
	/**
	 * Stores the name of this bubble set
	 */
	static public String name = "3DCircle 6 colors";
	/**
	 * Buffer the image
	 */
	 ...
	 */
	public Bubble3DCircleSix(int radius, int row, int col) {
	 ...
	 */
	public Bubble3DCircleSix(int radius, int row, int col, int colorIndex) {
